...
const User_1 = require("../src/modules/auth/domain/User");
const Planning_1 = require("../src/modules/planning/domain/Planning");
describe('User Entity', () => {
    ...
    describe('constructor', () => {
        it('should create a user with valid data', () => {
            const user = new User_1.User(validUserData.id, validUserData.email, validUserData.name, validUserData.gender);
...
describe('Planning Entity', () => {
    ...
    describe('constructor', () => {
        it('should create a planning with valid data', () => {
            const planning = new Planning_1.Planning(validPlanningData.id, validPlanningData.userId, validPlanningData.titre, validPlanningData.periode, validPlanningData.nombre, validPlanningData.dateDebut);
    ...
    describe('addSession', () => {
        it('should add a session', () => {
            const planning = new Planning_1.Planning(validPlanningData.id, validPlanningData.userId, validPlanningData.titre, validPlanningData.periode, validPlanningData.nombre, validPlanningData.dateDebut);
            const session = new Planning_1.PlanningSession('Mathématiques', new Date('2024-01-15T10:00:00'), new Date('2024-01-15T11:30:00'));
    ...
    describe('calculateTotalDuration', () => {
        it('should calculate total duration in minutes', () => {
            const planning = new Planning_1.Planning(validPlanningData.id, validPlanningData.userId, validPlanningData.titre, validPlanningData.periode, validPlanningData.nombre, validPlanningData.dateDebut);
            planning.addSession(new Planning_1.PlanningSession('Mathématiques', new Date('2024-01-15T10:00:00'), new Date('2024-01-15T11:00:00') // 60 minutes
            ));
            planning.addSession(new Planning_1.PlanningSession('Français', new Date('2024-01-15T12:00:00'), new Date('2024-01-15T12:30:00') // 30 minutes
            ));
    ...
    describe('calculateCompletionRate', () => {
        it('should calculate completion rate', () => {
            const planning = new Planning_1.Planning(validPlanningData.id, validPlanningData.userId, validPlanningData.titre, validPlanningData.periode, validPlanningData.nombre, validPlanningData.dateDebut);
            planning.addSession(new Planning_1.PlanningSession('Mathématiques', new Date('2024-01-15T10:00:00'), new Date('2024-01-15T11:00:00'), { statut: 'termine' }));
            planning.addSession(new Planning_1.PlanningSession('Français', new Date('2024-01-15T12:00:00'), new Date('2024-01-15T12:30:00'), { statut: 'planifie' }));
    ...
    describe('getSessionsBySubject', () => {
        it('should filter sessions by subject', () => {
            const planning = new Planning_1.Planning(validPlanningData.id, validPlanningData.userId, validPlanningData.titre, validPlanningData.periode, validPlanningData.nombre, validPlanningData.dateDebut);
            planning.addSession(new Planning_1.PlanningSession('Mathématiques', new Date('2024-01-15T10:00:00'), new Date('2024-01-15T11:00:00')));
            planning.addSession(new Planning_1.PlanningSession('Mathématiques', new Date('2024-01-15T14:00:00'), new Date('2024-01-15T15:00:00')));
            planning.addSession(new Planning_1.PlanningSession('Français', new Date('2024-01-15T12:00:00'), new Date('2024-01-15T12:30:00')));
